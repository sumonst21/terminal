...
namespace winrt::TerminalApp::implementation
{
    ...
    winrt::event_token AppLogic::SetTitleBarContent(Windows::Foundation::TypedEventHandler<winrt::Windows::Foundation::IInspectable, winrt::Windows::UI::Xaml::UIElement> const& handler)
    {
        return _root->SetTitleBarContent(handler);
    }
    void AppLogic::SetTitleBarContent(winrt::event_token const& token) noexcept
    {
        return _root->SetTitleBarContent(token);
    }

    winrt::event_token AppLogic::TitleChanged(Windows::Foundation::TypedEventHandler<winrt::Windows::Foundation::IInspectable, winrt::hstring> const& handler)
    {
        return _root->TitleChanged(handler);
    }
    void AppLogic::TitleChanged(winrt::event_token const& token) noexcept
    {
        return _root->TitleChanged(token);
    }

    winrt::event_token AppLogic::LastTabClosed(Windows::Foundation::TypedEventHandler<winrt::Windows::Foundation::IInspectable, winrt::TerminalApp::LastTabClosedEventArgs> const& handler)
    {
        return _root->LastTabClosed(handler);
    }
    void AppLogic::LastTabClosed(winrt::event_token const& token) noexcept
    {
